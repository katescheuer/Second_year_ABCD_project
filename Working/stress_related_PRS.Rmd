...
lm_resid_cbcl_list <- list() # initialize a list to store results  
...
cbcl_total_M1 <- lmer(res_c_total ~ zcmc_prs + zcmc_age + zcmc_income +
                        # gen_cmc_cisf + gen_cmc_gnc + 
                        # zcmc_prs*gen_cmc_cisf + zcmc_prs*gen_cmc_gnc +
                        anc_cmc_afr + anc_cmc_eur +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_total_M1)
