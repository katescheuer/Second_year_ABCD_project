...
cbcl_total_M2a <- lmer(res_c_total ~ zcmc_prs + zcmc_age + zcmc_income +
                      ...
                      (0+sex_cmc_cisf|site), #don't have enough to add more variables to random slope
...
# amadmix, all w sex instead of gender: failed to converge with either optimizer
...
# eur, afr, all w sex instead of gender: failed to converge with either optimizer
...
anova(cbcl_total_M1b,cbcl_total_M2d,test="Chisq") #1b is better than 2b
...
## Income-to-needs ----
### Intercept-Only Model Estimation (for Y) ----
income_to_needs_M0 <- lmer(income_to_needs ~ 1 + (1|site), data=yr4_reg_data, REML=FALSE)
summary(income_to_needs_M0)
...
### Random Intercept, Fixed Slopes without interactions ----
income_to_needs_M1a <- lmer(income_to_needs ~ zcmc_prs + zcmc_age + 
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
...
### Random Intercept, Fixed Slopes with interactions ----
income_to_needs_M1b <- lmer(income_to_needs ~ zcmc_prs + zcmc_age + 
                        sex_cmc_cisf  +
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
income_to_needs_M2a <- lmer(income_to_needs ~ zcmc_prs + zcmc_age + 
                        sex_cmc_cisf  +
                      (1|site)+(0+zcmc_prs|site)+
                      (0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
income_to_needs_M2b <- lmer(income_to_needs ~ zcmc_prs + zcmc_age + 
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age + zcmc_prs*
                        zcmc_prs*sex_cmc_cisf +  
                      (1|site)+(0+zcmc_prs|site)+
...
# income_to_needs_M2c <- lmer(income_to_needs ~ zcmc_prs + zcmc_age +
#                         sex_cmc_cisf  +
#                       (1+zcmc_prs+zcmc_age+
#                         sex_cmc_cisf  |site),
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
# income_to_needs_M2d <- lmer(income_to_needs ~ zcmc_prs + zcmc_age +
#                         sex_cmc_cisf  +
#                         zcmc_prs*zcmc_age + zcmc_prs*
#                         zcmc_prs*sex_cmc_cisf + 
#                       (1+zcmc_prs+zcmc_age+
...
## Gender ----
### Intercept-Only Model Estimation (for Y) ----
gender_M0 <- glmer(as.factor(gender) ~ 1 + (1|site), data = yr4_reg_data, family = binomial(link = "logit"))
summary(gender_M0)
...
### Random Intercept, Fixed Slopes without interactions ----
gender_M1a <- glmer(as.factor(gender) ~ zcmc_prs + zcmc_age + zcmc_income +
                      (1|site),data=yr4_reg_data, family = binomial(link = "logit"))
summary(gender_M1a)

### Random Intercept, Fixed Slopes with interactions ----
gender_M1b <- glmer(as.factor(gender) ~ zcmc_prs + zcmc_age + zcmc_income +
                        zcmc_prs*zcmc_age + zcmc_prs*zcmc_income +
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
gender_M2a <- glmer(as.factor(gender) ~ zcmc_prs + zcmc_age + zcmc_income +
                      (1|site)+(0+zcmc_prs|site)+
                      (0+zcmc_income|site)+(0+zcmc_age|site),
                    data=yr4_reg_data, family = binomial(link = "logit"),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
gender_M2b <- glmer(as.factor(gender) ~ zcmc_prs + zcmc_age + zcmc_income +
                        zcmc_prs*zcmc_age + zcmc_prs*zcmc_income +
                      (1|site)+(0+zcmc_prs|site)+
                      (0+zcmc_income|site)+(0+zcmc_age|site),
                    data=yr4_reg_data, family = binomial(link = "logit"),
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
gender_M2c <- glmer(as.factor(gender) ~ zcmc_prs + zcmc_age + zcmc_income +
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
gender_M2d <- glmer(as.factor(gender) ~ zcmc_prs + zcmc_age + zcmc_income +
                        zcmc_prs*zcmc_age + zcmc_prs*zcmc_income +
                      (1+zcmc_prs+zcmc_income+zcmc_age |site),
                    data=yr4_reg_data, family = binomial(link = "logit"),
                    control=glmerControl(optimizer="bobyqa"))
...
## Age ----
### Intercept-Only Model Estimation (for Y) ----
age_M0 <- lmer(age ~ 1 + (1|site), data=yr4_reg_data, REML=FALSE)
summary(age_M0)
...
### Random Intercept, Fixed Slopes without interactions ----
age_M1a <- lmer(age ~ zcmc_prs + zcmc_income + 
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(age_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
age_M1b <- lmer(age ~ zcmc_prs + zcmc_income + 
                        sex_cmc_cisf  +
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
age_M2a <- lmer(age ~ zcmc_prs + zcmc_income + 
                        sex_cmc_cisf  +
                      (1|site)+(0+zcmc_prs|site)+
                      (0+zcmc_income|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
age_M2b <- lmer(age ~ zcmc_prs + zcmc_income + 
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_income + zcmc_prs*
                        zcmc_prs*sex_cmc_cisf +  
                      (1|site)+(0+zcmc_prs|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
age_M2c <- lmer(age ~ zcmc_prs + zcmc_income +
                        sex_cmc_cisf  +
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
age_M2d <- lmer(age ~ zcmc_prs + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_income + zcmc_prs*
                        zcmc_prs*sex_cmc_cisf + 
                      (1+zcmc_prs+zcmc_income+
...
### Random Intercept, Fixed Slopes without interactions ----
cbcl_total_M1a <- lmer(res_c_total ~ zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_total_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
cbcl_total_M1b <- lmer(res_c_total ~  + zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
cbcl_total_M2a <- lmer(res_c_total ~  + zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_income|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site), #don't have enough to add more variables to random slope
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
cbcl_total_M2b <- lmer(res_c_total ~  + zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age + 
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc + 
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
cbcl_total_M2c <- lmer(res_c_total ~  + zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
# cbcl_total_M2d <- lmer(res_c_total ~  + zcmc_age + zcmc_income +
#                         sex_cmc_cisf  +
#                         zcmc_income*zcmc_age +
#                         zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc + 
#                       (1+zcmc_income+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
cbcl_ext_M1a <- lmer(res_c_ext ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_ext_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
cbcl_ext_M1b <- lmer(res_c_ext ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
cbcl_ext_M2a <- lmer(res_c_ext ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_income|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
cbcl_ext_M2b <- lmer(res_c_ext ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc + 
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
cbcl_ext_M2c <- lmer(res_c_ext ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1+zcmc_income+zcmc_age+
                        sex_cmc_cisf  |site),
                    data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
# cbcl_ext_M2d <- lmer(res_c_ext ~  zcmc_age + zcmc_income +
#                         sex_cmc_cisf  +
#                         zcmc_income*zcmc_age +
#                         zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
#                       (1+zcmc_income+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
cbcl_int_M1a <- lmer(res_c_int ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_int_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
cbcl_int_M1b <- lmer(res_c_int ~ zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
cbcl_int_M2a <- lmer(res_c_int ~ zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_income|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
cbcl_int_M2b <- lmer(res_c_int ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc + 
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
cbcl_int_M2c <- lmer(res_c_int ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1+zcmc_income+zcmc_age+
                        sex_cmc_cisf  |site),
                    data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
cbcl_int_M2d <- lmer(res_c_int ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
                      (1+zcmc_income+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
cbcl_aggress_M1a <- lmer(res_c_aggress ~ zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_aggress_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
cbcl_aggress_M1b <- lmer(res_c_aggress ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
cbcl_aggress_M2a <- lmer(res_c_aggress ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_income|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
cbcl_aggress_M2b <- lmer(res_c_aggress ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc + 
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
cbcl_aggress_M2c <- lmer(res_c_aggress ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1+zcmc_income+zcmc_age+
                        sex_cmc_cisf  |site),
                    # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
# cbcl_aggress_M2d <- lmer(res_c_aggress ~  zcmc_age + zcmc_income +
#                         sex_cmc_cisf  +
#                         zcmc_income*zcmc_age +
#                         zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
#                       (1+zcmc_income+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
cbcl_attn_M1a <- lmer(res_c_attn ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_attn_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
cbcl_attn_M1b <- lmer(res_c_attn ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
cbcl_attn_M2a <- lmer(res_c_attn ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_income|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
cbcl_attn_M2b <- lmer(res_c_attn ~  + zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc + 
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
# failed to converge with either optimizer
# cbcl_attn_M2c <- lmer(res_c_attn ~  zcmc_age + zcmc_income +
#                         sex_cmc_cisf  +
#                       (1+zcmc_income+zcmc_age+
#                         sex_cmc_cisf  |site),
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
# cbcl_attn_M2d <- lmer(res_c_attn ~  zcmc_age + zcmc_income +
#                         sex_cmc_cisf  +
#                         zcmc_income*zcmc_age +
#                         zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
#                       (1+zcmc_income+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
cbcl_anxdep_M1a <- lmer(res_c_anxdep ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_anxdep_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
cbcl_anxdep_M1b <- lmer(res_c_anxdep ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
cbcl_anxdep_M2a <- lmer(res_c_anxdep ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_income|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
cbcl_anxdep_M2b <- lmer(res_c_anxdep ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc + 
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
# failed to converge with either optimizer
# cbcl_anxdep_M2c <- lmer(res_c_anxdep ~  zcmc_age + zcmc_income +
#                         sex_cmc_cisf  +
#                       (1+zcmc_income+zcmc_age+
#                         sex_cmc_cisf  |site),
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
# cbcl_anxdep_M2d <- lmer(res_c_anxdep ~  zcmc_age + zcmc_income +
#                         sex_cmc_cisf  +
#                         zcmc_income*zcmc_age +
#                         zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
#                       (1+zcmc_income+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
cbcl_withdep_M1a <- lmer(res_c_withdep ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_withdep_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
cbcl_withdep_M1b <- lmer(res_c_withdep ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
cbcl_withdep_M2a <- lmer(res_c_withdep ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_income|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
cbcl_withdep_M2b <- lmer(res_c_withdep ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc + 
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
# failed to converge with either optimizer
# cbcl_withdep_M2c <- lmer(res_c_withdep ~  zcmc_age + zcmc_income +
#                         sex_cmc_cisf  +
#                       (1+zcmc_income+zcmc_age+
#                         sex_cmc_cisf  |site),
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
# cbcl_withdep_M2d <- lmer(res_c_withdep ~  + zcmc_age + zcmc_income +
#                         sex_cmc_cisf  +
#                         zcmc_income*zcmc_age +
#                         zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
#                       (1+zcmc_income+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
cbcl_rule_M1a <- lmer(res_c_rule ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_rule_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
cbcl_rule_M1b <- lmer(res_c_rule ~ zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
cbcl_rule_M2a <- lmer(res_c_rule ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_income|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
cbcl_rule_M2b <- lmer(res_c_rule ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc + 
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
cbcl_rule_M2c <- lmer(res_c_rule ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1+zcmc_income+zcmc_age+
                        sex_cmc_cisf  |site),
                    data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
# cbcl_rule_M2d <- lmer(res_c_rule ~  zcmc_age + zcmc_income +
#                         sex_cmc_cisf  +
#                         zcmc_income*zcmc_age +
#                         zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
#                       (1+zcmc_income+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
cbcl_social_M1a <- lmer(res_c_social ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_social_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
cbcl_social_M1b <- lmer(res_c_social ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
cbcl_social_M2a <- lmer(res_c_social ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_income|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
cbcl_social_M2b <- lmer(res_c_social ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc + 
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
# failed to converge with either optimizer
# cbcl_social_M2c <- lmer(res_c_social ~  zcmc_age + zcmc_income +
#                         sex_cmc_cisf  +
#                       (1+zcmc_income+zcmc_age+
#                         sex_cmc_cisf  |site),
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
# cbcl_social_M2d <- lmer(res_c_social ~ zcmc_age + zcmc_income +
#                         sex_cmc_cisf  +
#                         zcmc_income*zcmc_age +
#                         zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
#                       (1+zcmc_income+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
cbcl_somatic_M1a <- lmer(res_c_somatic ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_somatic_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
cbcl_somatic_M1b <- lmer(res_c_somatic ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
cbcl_somatic_M2a <- lmer(res_c_somatic ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_income|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
cbcl_somatic_M2b <- lmer(res_c_somatic ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc + 
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
cbcl_somatic_M2c <- lmer(res_c_somatic ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1+zcmc_income+zcmc_age+
                        sex_cmc_cisf  |site),
                    data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
cbcl_somatic_M2d <- lmer(res_c_somatic ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
                      (1+zcmc_income+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
cbcl_thought_M1a <- lmer(res_c_thought ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_thought_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
cbcl_thought_M1b <- lmer(res_c_thought ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
cbcl_thought_M2a <- lmer(res_c_thought ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_income|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
cbcl_thought_M2b <- lmer(res_c_thought ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc + 
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
# failed to converge with either optimizer
# cbcl_thought_M2c <- lmer(res_c_thought ~  zcmc_age + zcmc_income +
#                         sex_cmc_cisf  +
#                       (1+zcmc_income+zcmc_age+
#                         sex_cmc_cisf  |site),
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
# cbcl_thought_M2d <- lmer(res_c_thought ~  zcmc_age + zcmc_income +
#                         sex_cmc_cisf  +
#                         zcmc_income*zcmc_age +
#                         zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
#                       (1+zcmc_income+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
ksads_adhd_M1a <- lmer(res_k_adhd ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(ksads_adhd_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
ksads_adhd_M1b <- lmer(res_k_adhd ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
ksads_adhd_M2a <- lmer(res_k_adhd ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_income|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
ksads_adhd_M2b <- lmer(res_k_adhd ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc + 
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
ksads_adhd_M2c <- lmer(res_k_adhd ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1+zcmc_income+zcmc_age+
                        sex_cmc_cisf  |site),
                    data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
ksads_adhd_M2d <- lmer(res_k_adhd ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
                      (1+zcmc_income+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
ksads_gad_M1a <- lmer(res_k_gad ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(ksads_gad_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
ksads_gad_M1b <- lmer(res_k_gad ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
ksads_gad_M2a <- lmer(res_k_gad ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_income|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
ksads_gad_M2b <- lmer(res_k_gad ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc + 
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
ksads_gad_M2c <- lmer(res_k_gad ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1+zcmc_income+zcmc_age+
                        sex_cmc_cisf  |site),
                    data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
# ksads_gad_M2d <- lmer(res_k_gad ~  zcmc_age + zcmc_income +
#                         sex_cmc_cisf  +
#                         zcmc_income*zcmc_age +
#                         zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
#                       (1+zcmc_income+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
ksads_mdd_M1a <- lmer(res_k_mdd ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(ksads_mdd_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
ksads_mdd_M1b <- lmer(res_k_mdd ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
ksads_mdd_M2a <- lmer(res_k_mdd ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_income|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
ksads_mdd_M2b <- lmer(res_k_mdd ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc + 
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
# failed to converge with either optimizer
# ksads_mdd_M2c <- lmer(res_k_mdd ~  zcmc_age + zcmc_income +
#                         sex_cmc_cisf  +
#                       (1+zcmc_income+zcmc_age+
#                         sex_cmc_cisf  |site),
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
# ksads_mdd_M2d <- lmer(res_k_mdd ~  zcmc_age + zcmc_income +
#                         sex_cmc_cisf  +
#                         zcmc_income*zcmc_age +
#                         zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
#                       (1+zcmc_income+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
ksads_ptsd_M1a <- lmer(res_k_ptsd ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(ksads_ptsd_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
ksads_ptsd_M1b <- lmer(res_k_ptsd ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
ksads_ptsd_M2a <- lmer(res_k_ptsd ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_income|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
ksads_ptsd_M2b <- lmer(res_k_ptsd ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                        zcmc_income*zcmc_age +
                        zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc + 
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
ksads_ptsd_M2c <- lmer(res_k_ptsd ~  zcmc_age + zcmc_income +
                        sex_cmc_cisf  +
                      (1+zcmc_income+zcmc_age+
                        sex_cmc_cisf  |site),
                    data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
# ksads_ptsd_M2d <- lmer(res_k_ptsd ~  zcmc_age + zcmc_income +
#                         sex_cmc_cisf  +
#                         zcmc_income*zcmc_age +
#                         zcmc_income*sex_cmc_cisf + zcmc_income*gen_cmc_gnc +
#                       (1+zcmc_income+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
cbcl_total_M1a <- lmer(res_c_total ~ zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_total_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
cbcl_total_M1b <- lmer(res_c_total ~  + zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf + 
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
cbcl_total_M2a <- lmer(res_c_total ~  + zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_prs|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site), #don't have enough to add more variables to random slope
                    data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
summary(cbcl_total_M2a)

### Random Intercept, random slopes, random effects uncorrelated with interactions ----
cbcl_total_M2b <- lmer(res_c_total ~  + zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age + 
                        zcmc_prs*sex_cmc_cisf +  
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
# failed to converge with either optimizer
# cbcl_total_M2c <- lmer(res_c_total ~  + zcmc_age + zcmc_prs +
#                         sex_cmc_cisf  +
#                       (1+zcmc_prs+zcmc_age+
#                         sex_cmc_cisf  |site),
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
cbcl_total_M2d <- lmer(res_c_total ~  + zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf + 
                      (1+zcmc_prs+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
cbcl_ext_M1a <- lmer(res_c_ext ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_ext_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
cbcl_ext_M1b <- lmer(res_c_ext ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf + 
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
cbcl_ext_M2a <- lmer(res_c_ext ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_prs|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
cbcl_ext_M2b <- lmer(res_c_ext ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf +  
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
# failed to converge with either optimizer
# cbcl_ext_M2c <- lmer(res_c_ext ~  zcmc_age + zcmc_prs +
#                         sex_cmc_cisf  +
#                       (1+zcmc_prs+zcmc_age+
#                         sex_cmc_cisf  |site),
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
cbcl_ext_M2d <- lmer(res_c_ext ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf + 
                      (1+zcmc_prs+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
cbcl_int_M1a <- lmer(res_c_int ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_int_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
cbcl_int_M1b <- lmer(res_c_int ~ zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf + 
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
cbcl_int_M2a <- lmer(res_c_int ~ zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_prs|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
cbcl_int_M2b <- lmer(res_c_int ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf +  
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
# failed to converge with either optimizer
# cbcl_int_M2c <- lmer(res_c_int ~  zcmc_age + zcmc_prs +
#                         sex_cmc_cisf  +
#                       (1+zcmc_prs+zcmc_age+
#                         sex_cmc_cisf  |site),
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
cbcl_int_M2d <- lmer(res_c_int ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf + 
                      (1+zcmc_prs+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
cbcl_aggress_M1a <- lmer(res_c_aggress ~ zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_aggress_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
cbcl_aggress_M1b <- lmer(res_c_aggress ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf + 
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
cbcl_aggress_M2a <- lmer(res_c_aggress ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_prs|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
cbcl_aggress_M2b <- lmer(res_c_aggress ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf +  
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
# failed to converge with either optimizer
# cbcl_aggress_M2c <- lmer(res_c_aggress ~  zcmc_age + zcmc_prs +
#                         sex_cmc_cisf  +
#                       (1+zcmc_prs+zcmc_age+
#                         sex_cmc_cisf  |site),
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
# cbcl_aggress_M2d <- lmer(res_c_aggress ~  zcmc_age + zcmc_prs +
#                         sex_cmc_cisf  +
#                         zcmc_prs*zcmc_age +
#                         zcmc_prs*sex_cmc_cisf + 
#                       (1+zcmc_prs+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
cbcl_attn_M1a <- lmer(res_c_attn ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_attn_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
cbcl_attn_M1b <- lmer(res_c_attn ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf + 
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
cbcl_attn_M2a <- lmer(res_c_attn ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_prs|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
cbcl_attn_M2b <- lmer(res_c_attn ~  + zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf +  
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
# failed to converge with either optimizer
# cbcl_attn_M2c <- lmer(res_c_attn ~  zcmc_age + zcmc_prs +
#                         sex_cmc_cisf  +
#                       (1+zcmc_prs+zcmc_age+
#                         sex_cmc_cisf  |site),
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
# cbcl_attn_M2d <- lmer(res_c_attn ~  zcmc_age + zcmc_prs +
#                         sex_cmc_cisf  +
#                         zcmc_prs*zcmc_age +
#                         zcmc_prs*sex_cmc_cisf + 
#                       (1+zcmc_prs+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
cbcl_anxdep_M1a <- lmer(res_c_anxdep ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_anxdep_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
cbcl_anxdep_M1b <- lmer(res_c_anxdep ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf + 
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
cbcl_anxdep_M2a <- lmer(res_c_anxdep ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_prs|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
cbcl_anxdep_M2b <- lmer(res_c_anxdep ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf +  
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
# failed to converge with either optimizer
# cbcl_anxdep_M2c <- lmer(res_c_anxdep ~  zcmc_age + zcmc_prs +
#                         sex_cmc_cisf  +
#                       (1+zcmc_prs+zcmc_age+
#                         sex_cmc_cisf  |site),
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
# cbcl_anxdep_M2d <- lmer(res_c_anxdep ~  zcmc_age + zcmc_prs +
#                         sex_cmc_cisf  +
#                         zcmc_prs*zcmc_age +
#                         zcmc_prs*sex_cmc_cisf + 
#                       (1+zcmc_prs+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
cbcl_withdep_M1a <- lmer(res_c_withdep ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_withdep_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
cbcl_withdep_M1b <- lmer(res_c_withdep ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf + 
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
cbcl_withdep_M2a <- lmer(res_c_withdep ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_prs|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
cbcl_withdep_M2b <- lmer(res_c_withdep ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf +  
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
# failed to converge with either optimizer
# cbcl_withdep_M2c <- lmer(res_c_withdep ~  zcmc_age + zcmc_prs +
#                         sex_cmc_cisf  +
#                       (1+zcmc_prs+zcmc_age+
#                         sex_cmc_cisf  |site),
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
# cbcl_withdep_M2d <- lmer(res_c_withdep ~  + zcmc_age + zcmc_prs +
#                         sex_cmc_cisf  +
#                         zcmc_prs*zcmc_age +
#                         zcmc_prs*sex_cmc_cisf + 
#                       (1+zcmc_prs+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
cbcl_rule_M1a <- lmer(res_c_rule ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_rule_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
cbcl_rule_M1b <- lmer(res_c_rule ~ zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf + 
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
cbcl_rule_M2a <- lmer(res_c_rule ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_prs|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
cbcl_rule_M2b <- lmer(res_c_rule ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf +  
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
cbcl_rule_M2c <- lmer(res_c_rule ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1+zcmc_prs+zcmc_age+
                        sex_cmc_cisf  |site),
                    data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
# cbcl_rule_M2d <- lmer(res_c_rule ~  zcmc_age + zcmc_prs +
#                         sex_cmc_cisf  +
#                         zcmc_prs*zcmc_age +
#                         zcmc_prs*sex_cmc_cisf + 
#                       (1+zcmc_prs+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
cbcl_social_M1a <- lmer(res_c_social ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_social_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
cbcl_social_M1b <- lmer(res_c_social ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf + 
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
cbcl_social_M2a <- lmer(res_c_social ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_prs|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
cbcl_social_M2b <- lmer(res_c_social ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf +  
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
# failed to converge with either optimizer
# cbcl_social_M2c <- lmer(res_c_social ~  zcmc_age + zcmc_prs +
#                         sex_cmc_cisf  +
#                       (1+zcmc_prs+zcmc_age+
#                         sex_cmc_cisf  |site),
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
# cbcl_social_M2d <- lmer(res_c_social ~ zcmc_age + zcmc_prs +
#                         sex_cmc_cisf  +
#                         zcmc_prs*zcmc_age +
#                         zcmc_prs*sex_cmc_cisf + 
#                       (1+zcmc_prs+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
cbcl_somatic_M1a <- lmer(res_c_somatic ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_somatic_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
cbcl_somatic_M1b <- lmer(res_c_somatic ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf + 
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
cbcl_somatic_M2a <- lmer(res_c_somatic ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_prs|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
cbcl_somatic_M2b <- lmer(res_c_somatic ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf +  
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
# failed to converge with either optimizer
# cbcl_somatic_M2c <- lmer(res_c_somatic ~  zcmc_age + zcmc_prs +
#                         sex_cmc_cisf  +
#                       (1+zcmc_prs+zcmc_age+
#                         sex_cmc_cisf  |site),
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
# cbcl_somatic_M2d <- lmer(res_c_somatic ~  zcmc_age + zcmc_prs +
#                         sex_cmc_cisf  +
#                         zcmc_prs*zcmc_age +
#                         zcmc_prs*sex_cmc_cisf + 
#                       (1+zcmc_prs+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
cbcl_thought_M1a <- lmer(res_c_thought ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_thought_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
cbcl_thought_M1b <- lmer(res_c_thought ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf + 
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
cbcl_thought_M2a <- lmer(res_c_thought ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_prs|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
cbcl_thought_M2b <- lmer(res_c_thought ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf +  
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
# failed to converge with either optimizer
# cbcl_thought_M2c <- lmer(res_c_thought ~  zcmc_age + zcmc_prs +
#                         sex_cmc_cisf  +
#                       (1+zcmc_prs+zcmc_age+
#                         sex_cmc_cisf  |site),
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
# cbcl_thought_M2d <- lmer(res_c_thought ~  zcmc_age + zcmc_prs +
#                         sex_cmc_cisf  +
#                         zcmc_prs*zcmc_age +
#                         zcmc_prs*sex_cmc_cisf + 
#                       (1+zcmc_prs+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
ksads_adhd_M1a <- lmer(res_k_adhd ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(ksads_adhd_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
ksads_adhd_M1b <- lmer(res_k_adhd ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf + 
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
ksads_adhd_M2a <- lmer(res_k_adhd ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_prs|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
ksads_adhd_M2b <- lmer(res_k_adhd ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf +  
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
ksads_adhd_M2c <- lmer(res_k_adhd ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1+zcmc_prs+zcmc_age+
                        sex_cmc_cisf  |site),
                    data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
ksads_adhd_M2d <- lmer(res_k_adhd ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf + 
                      (1+zcmc_prs+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
ksads_gad_M1a <- lmer(res_k_gad ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(ksads_gad_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
ksads_gad_M1b <- lmer(res_k_gad ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf + 
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
ksads_gad_M2a <- lmer(res_k_gad ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_prs|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
ksads_gad_M2b <- lmer(res_k_gad ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf +  
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
# failed to converge with either optimizer
# ksads_gad_M2c <- lmer(res_k_gad ~  zcmc_age + zcmc_prs +
#                         sex_cmc_cisf  +
#                       (1+zcmc_prs+zcmc_age+
#                         sex_cmc_cisf  |site),
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
# ksads_gad_M2d <- lmer(res_k_gad ~  zcmc_age + zcmc_prs +
#                         sex_cmc_cisf  +
#                         zcmc_prs*zcmc_age +
#                         zcmc_prs*sex_cmc_cisf + 
#                       (1+zcmc_prs+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
ksads_mdd_M1a <- lmer(res_k_mdd ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(ksads_mdd_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
ksads_mdd_M1b <- lmer(res_k_mdd ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf + 
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
ksads_mdd_M2a <- lmer(res_k_mdd ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_prs|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
ksads_mdd_M2b <- lmer(res_k_mdd ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf +  
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
ksads_mdd_M2c <- lmer(res_k_mdd ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1+zcmc_prs+zcmc_age+
                        sex_cmc_cisf  |site),
                    # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
ksads_mdd_M2d <- lmer(res_k_mdd ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf + 
                      (1+zcmc_prs+zcmc_age+
...
### Random Intercept, Fixed Slopes without interactions ----
ksads_ptsd_M1a <- lmer(res_k_ptsd ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(ksads_ptsd_M1a)
...
### Random Intercept, Fixed Slopes with interactions ----
ksads_ptsd_M1b <- lmer(res_k_ptsd ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf + 
                      (1|site),
...
### Random Intercept, random slopes, random effects uncorrelated without interactions ----
ksads_ptsd_M2a <- lmer(res_k_ptsd ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                      (1|site)+
                      (0+zcmc_prs|site)+(0+zcmc_age|site)+
                      (0+sex_cmc_cisf|site),
...
### Random Intercept, random slopes, random effects uncorrelated with interactions ----
ksads_ptsd_M2b <- lmer(res_k_ptsd ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf +  
                      (1|site)+
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
# failed to converge with either optimizer
# ksads_ptsd_M2c <- lmer(res_k_ptsd ~  zcmc_age + zcmc_prs +
#                         sex_cmc_cisf  +
#                       (1+zcmc_prs+zcmc_age+
#                         sex_cmc_cisf  |site),
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# failed to converge with either optimizer
ksads_ptsd_M2d <- lmer(res_k_ptsd ~  zcmc_age + zcmc_prs +
                        sex_cmc_cisf  +
                        zcmc_prs*zcmc_age +
                        zcmc_prs*sex_cmc_cisf + 
                      (1+zcmc_prs+zcmc_age+
