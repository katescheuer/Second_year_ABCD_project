...
ksads_lifetime <- read.csv("ABCD_Baseline_T1_T2_T3_T4_KSADS_Lifetime_Diagnoses(in).csv") #lifetime ksads diagnoses
le_p <- read.csv("mh_p_le.csv",header=T) #parent-reported life events scale
le_y <- read.csv("mh_y_le.csv",header=T) #parent-reported life events scale
