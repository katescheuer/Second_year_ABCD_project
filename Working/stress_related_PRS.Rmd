...
# 1a gender: aic = 14822.4, bic = 14870.9
# 1a sex: aic = 14971.9, bic = 15014.4
...
anova(cbcl_thought_M1b,cbcl_thought_M2a,test="Chisq") #all, eur, amadmix: 1b is better
...
# all, eur: best fitting model is fixed slope without interactions
# all, eur: if want to include interactions, use fixed slope
...
# all, afr: best fitting model is fixed slope without interactions
# all, afr: if want to include interactions, use fixed slope
...
### Model Comparisons of AIC/BIC fit indices and Likelihood Ratio Test (LRT) ----
anova(ksads_ptsd_M1a,ksads_ptsd_M1b,test="Chisq")  #all, eur: 1a is better; afr: 1b is better
anova(ksads_ptsd_M1a,ksads_ptsd_M2a,test="Chisq") #all, eur: 1a is better
anova(ksads_ptsd_M1a,ksads_ptsd_M2b,test="Chisq") #all, eur: 1a is better
...
anova(ksads_ptsd_M1b,ksads_ptsd_M2b,test="Chisq") #all, eur: 1b is better
# all, eur: best fitting model is fixed slope without interactions
# all, eur: if want to include interactions, use fixed slope
