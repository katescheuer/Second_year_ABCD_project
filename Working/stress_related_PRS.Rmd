...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # 0.1% of the variance in Externalizing problems is explained by site
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # 0.01% of the variance in Externalizing problems is explained by site
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # 0.3% of the variance in Externalizing problems is explained by site
...
START HERE WITH RULE BREAKING CBCL



EXPLORE RELATIONSHIP BETWEEN PRS AND INCOME TO NEEDS - SIG IXN WITH GENDER

test <- lmer(income_to_needs ~ zcmc_prs + zcmc_age +
                 gen_cmc_cisf + gen_cmc_gnc +
                 zcmc_prs*zcmc_age +
                 zcmc_prs*gen_cmc_cisf + zcmc_prs*gen_cmc_gnc +
                 (1|site),
