...
ICC_Y2 # 0.3% (all) or 0.6% (eur) or 0% (afr) of the variance in total problems is explained by site
...
# all, eur, afr: best fitting model is fixed slope without interactions
# all, eur, afr: if want to include interactions, use fixed slope
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # 0.2% (all) or 0.4% (eur) or 0% (afr) of the variance in Externalizing problems is explained by site
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # 0.2% (all, eur) or 0% (afr) of the variance in internalizing problems is explained by site
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # 0.1% (all) or 0.04% (eur) or 0% (afr) of the variance in aggression problems is explained by site
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
# afr: failed to converge with either optimizer
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # 0.1% (all) or 0% (eur, afr) of the variance in attention problems is explained by site
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # 0.01% (all) or 0% (eur, afr) of the variance in anxious/depressed problems is explained by site
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # 0.3% (all) or 0.5% (eur) or 0% (afr) of variance in withdrawn/depressed problems is explained by site
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # 0.04% (all) or 0.2% (eur) or 0% (afr) of the variance in rule-breaking problems is explained by site
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # 0% (all, eur, afr) of the variance in social problems is explained by site
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # 0.4% (all) or 0.6% (eur) or 0.06% (afr) of the variance in somatic problems is explained by site
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # 0% (all, eur, afr) of the variance in thought problems is explained by site
...
### Model Comparisons of AIC/BIC fit indices and Likelihood Ratio Test (LRT) ----
anova(cbcl_thought_M1a,cbcl_thought_M1b,test="Chisq")  #all, eur: 1b is better; afr: 1a is better
anova(cbcl_thought_M1b,cbcl_thought_M2a,test="Chisq") #all, eur: 1b is better
anova(cbcl_thought_M1b,cbcl_thought_M2b,test="Chisq") #all, eur: 1b is better
...
# all, eur: best fitting model is fixed slope with interactions
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # 0% (all, eur, afr) of the variance in gad diagnoses is explained by site
...
##      M1b: icisf, gnc, prs*gnc (p = 0.04139) (income: p = 0.2572)
## Afr: 
##      M1a: no sig
##      M1b: no sig
