...
ICC_Y2 # 0.4% of the variance in total problems is explained by site
...
cbcl_total_M1b_gender <- lmer(res_c_total ~ zcmc_prs + zcmc_age + zcmc_income +
                        ...
                        zcmc_prs*anc_cmc_afr + zcmc_prs*anc_cmc_eur +
...
# 1a gender: aic = 14825.1, bic = 14885.7
# 1a sex: aic = 14974.9, bic = 15029.6
# all: choose model 1a gender

### Sig Results ----
## income: p = 0.0199, beta = -0.101132
## cisf: p < 0.0001, beta = -0.600253 (compared to avg)
## gnc: p < 0.0001, beta = 1.279493 (compared to avg)
...
# 1a gender: aic = 14479.8, bic = 14540.5
# 1a sex: aic = 14611.6, bic = 14666.2
# all: choose model 1a gender

### Sig Results ----
## income: p = 0.0006, beta = -0.14077
## cisf: p < 0.0001, beta = -0.49082 (compared to avg)
## gnc: p < 0.0001, beta = 0.76764 (compared to avg)
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # 0.2% of the variance in ing problems is explained by site
...
# 1a gender: aic = 16546.9, bic = 16607.6
# 1a sex: aic = 16689.9, bic = 16744.6
# all: choose model 1a gender

### Sig Results ----
## cisf: p < 0.0001, beta = -0.669625 (compared to avg)
## gnc: p < 0.0001, beta = 1.704377 (compared to avg)
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # 0.1% of the variance in aggress problems is explained by site
...
# 1a gender: aic = 10927.7, bic = 10988.4
# 1a sex: aic = 11047.9, bic = 11102.6
# all: choose model 1a gender

### Sig Results ----
## income: p = 0.000274, beta = -0.0860834
## cisf: p < 0.0001, beta = -0.2265903 (compared to avg)
## gnc: p = 0.003567, beta = 0.3008662 (compared to avg)
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # 0.1% of the variance in attn problems is explained by site
...
# 1a gender: aic = 14450.4, bic = 14511.1
# 1a sex: aic = 14681.2, bic = 14735.9
# all: choose model 1a gender

### Sig Results ----
## cisf: p < 0.0001, beta = -0.707194 (compared to avg)
## gnc: p = 0.003567, beta = 1.440571 (compared to avg)
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # 0.0% of the variance in anxdep problems is explained by site
...
# 1a gender: aic = 14547.6, bic = 14608.3
# 1a sex: aic = 14701.3, bic = 14755.9
# all: choose model 1a gender

### Sig Results ----
## eur: p = 0.0477, beta = -0.13915 (compared to avg)
## cisf: p < 0.0001, beta = -0.45654 (compared to avg)
## gnc: p = 0.003567, beta = 1.15143 (compared to avg)
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # 0.2% of the variance in withdep problems is explained by site
...
# 1a gender: aic = 12455.9, bic = 12516.6
# 1a sex: aic = 12601.9, bic = 12656.6
# all: choose model 1a gender

### Sig Results ----
## income: p = 0.000398, beta = -0.1063 (compared to avg)
## cisf: p < 0.0001, beta = -0.4785 (compared to avg)
## gnc: p = 0.003567, beta = 0.9937 (compared to avg)
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # 0.05% of the variance in rule problems is explained by site
...
# 1a gender: aic = 8393.1, bic = 8453.8
# 1a sex: aic = 8542.7, bic = 8597.4
# all: choose model 1a gender

### Sig Results ----
## income: p < 0.0001, beta = -0.06484 (compared to avg)
## cisf: p < 0.0001, beta = -0.1641 (compared to avg)
## gnc: p < 0.0001, beta = 0.2995 (compared to avg)
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # >0.00% of the variance in social problems is explained by site
...
anova(cbcl_social_M1a_sex,cbcl_social_M2d_sex,test="Chisq") #1a is better
...
# 1a gender: aic = 11802.9, bic = 11863.6
# 1a sex: aic = 11905.1, bic = 11959.7
# all: choose model 1a gender

### Sig Results ----
## income: p < 0.0001, beta = -0.1202 (compared to avg)
## cisf: p = 0.00206, beta = -0.2028 (compared to avg)
## gnc: p = 0.00183, beta = 0.3692 (compared to avg)
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # 0.04% of the variance in somatic problems is explained by site
...
# 1a gender: aic = 14228.5, bic = 14289.2
# 1a sex: aic = 14336.0, bic = 14390.7
# all: choose model 1a gender
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # >0.01% of the variance in thought problems is explained by site
...
anova(cbcl_thought_M1a_sex,cbcl_thought_M2a_sex,test="Chisq") #2a is better
anova(cbcl_thought_M2a_sex,cbcl_thought_M2b_sex,test="Chisq") #2a is better
...
# 1a gender: aic = 12797.6, bic = 12858.3
# 2a sex: aic = 13005.0, bic = 13096.1
# all: choose model 1a gender

### Sig Results ----
## prs: p = 0.00805, beta = 0.035578
## income: p = 0.00757, beta = -0.084630 (compared to avg)
## cisf: p < 0.0001, beta = -0.660556 (compared to avg)
## gnc: p < 0.0001, beta = 1.355486 (compared to avg)
...
resid_var = variances[2,'vcov']
ICC_Y2 <- cluster_var/(cluster_var + resid_var)
ICC_Y2 # <0.01% of the variance in adhd diagnoses is explained by site

### Random Intercept, Fixed Slopes without interactions ----
ksads_adhd_M1a_gender <- lmer(res_k_adhd ~ zcmc_prs + zcmc_age + zcmc_income +
                              anc_cmc_afr + anc_cmc_eur +
                              gen_cmc_cisf + gen_cmc_gnc +
                            (1|site),
                          data=yr4_reg_data, REML=FALSE)
summary(ksads_adhd_M1a_gender)
ksads_adhd_M1a_sex <- lmer(res_k_adhd ~ zcmc_prs + zcmc_age + zcmc_income +
                              anc_cmc_afr + anc_cmc_eur +
                              sex_cmc_cisf +
                            (1|site),
                          data=yr4_reg_data, REML=FALSE)
summary(ksads_adhd_M1a_sex)

### Random Intercept, Fixed Slopes with interactions ----
ksads_adhd_M1b_gender <- lmer(res_k_adhd ~ zcmc_prs + zcmc_age + zcmc_income +
                        anc_cmc_afr + anc_cmc_eur +
                        gen_cmc_cisf + gen_cmc_gnc +
                        zcmc_prs*zcmc_age + zcmc_prs*zcmc_income +
                        zcmc_prs*anc_cmc_afr + zcmc_prs*anc_cmc_eur +
                      ...
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(ksads_adhd_M1b_gender)
ksads_adhd_M1b_sex <- lmer(res_k_adhd ~ zcmc_prs + zcmc_age + zcmc_income +
                        anc_cmc_afr + anc_cmc_eur +
                        sex_cmc_cisf +
                        zcmc_prs*zcmc_age + zcmc_prs*zcmc_income +
                        zcmc_prs*anc_cmc_afr + zcmc_prs*anc_cmc_eur +
                      ...
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(ksads_adhd_M1b_sex)

### Random Intercept, random slopes, random effects uncorrelated without interactions ----
ksads_adhd_M2a_gender <- lmer(res_k_adhd ~ zcmc_prs + zcmc_age + zcmc_income +
                        anc_cmc_afr + anc_cmc_eur +
                        gen_cmc_cisf + gen_cmc_gnc +
                      (1|site)+(0+zcmc_prs|site)+
                      (0+zcmc_income|site)+(0+zcmc_age|site)+
                      ...
                      (0+gen_cmc_cisf|site)+(0+gen_cmc_gnc|site),
                    data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
summary(ksads_adhd_M2a_gender)
ksads_adhd_M2a_sex <- lmer(res_k_adhd ~ zcmc_prs + zcmc_age + zcmc_income +
                        anc_cmc_afr + anc_cmc_eur +
                        sex_cmc_cisf +
                      (1|site)+(0+zcmc_prs|site)+
                      (0+zcmc_income|site)+(0+zcmc_age|site)+
                      ...
                      (0+sex_cmc_cisf|site),
                    data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
summary(ksads_adhd_M2a_sex)

### Random Intercept, random slopes, random effects uncorrelated with interactions ----
ksads_adhd_M2b_gender <- lmer(res_k_adhd ~ zcmc_prs + zcmc_age + zcmc_income +
                        anc_cmc_afr + anc_cmc_eur +
                        gen_cmc_cisf + gen_cmc_gnc +
                        zcmc_prs*zcmc_age + zcmc_prs*zcmc_income +
                        zcmc_prs*gen_cmc_cisf + zcmc_prs*gen_cmc_gnc + 
                      ...
                      (0+gen_cmc_cisf|site)+(0+gen_cmc_gnc|site),
                    data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
summary(ksads_adhd_M2b_gender)
ksads_adhd_M2b_sex <- lmer(res_k_adhd ~ zcmc_prs + zcmc_age + zcmc_income +
                        anc_cmc_afr + anc_cmc_eur +
                        sex_cmc_cisf +
                        zcmc_prs*zcmc_age + zcmc_prs*zcmc_income +
                        zcmc_prs*sex_cmc_cisf + 
                      ...
                      (0+sex_cmc_cisf|site),
                    data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
summary(ksads_adhd_M2b_sex)

### Random Intercept, random slopes, random effects free to correlate without interactions ----
# gender failed to converge with either optimizer
# ksads_adhd_M2c_gender <- lmer(res_k_adhd ~ zcmc_prs + zcmc_age + zcmc_income +
#                         anc_cmc_afr + anc_cmc_eur +
#                         gen_cmc_cisf + gen_cmc_gnc +
#                       (1+zcmc_prs+zcmc_income+zcmc_age+
#                         anc_cmc_afr + anc_cmc_eur +
...
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="Nelder_Mead"))
# summary(ksads_adhd_M2c_gender)
# sex failed to converge with either optimizer
# ksads_adhd_M2c_sex <- lmer(res_k_adhd ~ zcmc_prs + zcmc_age + zcmc_income +
#                         anc_cmc_afr + anc_cmc_eur +
#                         sex_cmc_cisf +
#                       (1+zcmc_prs+zcmc_income+zcmc_age+
#                         anc_cmc_afr + anc_cmc_eur +
...
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="Nelder_Mead"))
# summary(ksads_adhd_M2c_sex)

### Random Intercept, random slopes, random effects free to correlate with interactions ----
# gender failed to converge with either optimizer
# ksads_adhd_M2d_gender <- lmer(res_k_adhd ~ zcmc_prs + zcmc_age + zcmc_income +
#                         anc_cmc_afr + anc_cmc_eur +
#                         gen_cmc_cisf + gen_cmc_gnc +
#                         zcmc_prs*zcmc_age + zcmc_prs*zcmc_income +
#                         zcmc_prs*gen_cmc_cisf + zcmc_prs*gen_cmc_gnc +
...
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="Nelder_Mead"))
# summary(ksads_adhd_M2d_gender)
# sex failed to converge with either optimizer
# ksads_adhd_M2d_sex <- lmer(res_k_adhd ~ zcmc_prs + zcmc_age + zcmc_income +
#                         anc_cmc_afr + anc_cmc_eur +
#                         sex_cmc_cisf +
#                         zcmc_prs*zcmc_age + zcmc_prs*zcmc_income +
#                         zcmc_prs*sex_cmc_cisf +
...
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="bobyqa"))
#                     # data=yr4_reg_data, REML=FALSE,control=lmerControl(optimizer="Nelder_Mead"))
# summary(ksads_adhd_M2d_sex)

### Model Comparisons of AIC/BIC fit indices and Likelihood Ratio Test (LRT) ----
anova(ksads_adhd_M1a_sex,ksads_adhd_M1b_sex,test="Chisq")  #1a is better
anova(ksads_adhd_M1a_sex,ksads_adhd_M2a_sex,test="Chisq") #2a is better
anova(ksads_adhd_M2a_sex,ksads_adhd_M2b_sex,test="Chisq") #2a is better

anova(ksads_adhd_M1a_gender,ksads_adhd_M1b_gender,test="Chisq")  #1a is better
anova(ksads_adhd_M1a_gender,ksads_adhd_M2a_gender,test="Chisq") #2a is better
anova(ksads_adhd_M2a_gender,ksads_adhd_M2b_gender,test="Chisq") #2a is better

# 2a gender: aic = 20824.5, bic = 20927.7
# 2a sex: aic = 20924.6, bic = 21015.7
# all: choose model 2a gender
...
anova(ksads_gad_M1a_gender,ksads_gad_M2b_gender,test="Chisq") #2a is better

# 1a gender: aic = 17986.8, bic = 18047.5
# 1a sex: aic = 18084.9, bic = 18139.6
# all: choose model 1a gender

### Sig Results ----
## cisf: p = 0.029806, beta = -0.37626 (compared to avg)
## gnc: p = 0.000134, beta = 1.19109 (compared to avg)
...
anova(ksads_mdd_M1a_sex,ksads_mdd_M2a_sex,test="Chisq") #2a is better
anova(ksads_mdd_M2a_sex,ksads_mdd_M2b_sex,test="Chisq") #2a is better

anova(ksads_mdd_M1a_gender,ksads_mdd_M1b_gender,test="Chisq")  #1b is better
anova(ksads_mdd_M1b_gender,ksads_mdd_M2a_gender,test="Chisq") #1b is better
anova(ksads_mdd_M1b_gender,ksads_mdd_M2b_gender,test="Chisq") #1b is better

# 1b gender: aic = 20657.8, bic = 20754.9
# 2a sex: aic = 20876.1, bic = 20967.2
# all: choose model 1b gender

### Sig Results ----
## cisf: p = 0.0135, beta = -0.653625 (compared to avg)
## gnc: p < 0.0001, beta = 2.324721 (compared to avg)
## prs*gnc: p = 0.0369, beta = 0.401658 (compared to avg)
...
# 1a gender: aic = 18856.2, bic = 18916.9
# 1a sex: aic = 18953.1, bic = 19007.8
# all: choose model 1a gender

### Sig Results ----
## income: p = 0.0186, beta = -0.19249
## gnc: p < 0.0001, beta = 2.324721 (compared to avg)
