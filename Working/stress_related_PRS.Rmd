...
### European ancestry only, yr 4: cbcl or ksads ~ stress prs + sex + age + ancestry PCs

``` {eur ancestry only, yr 4: cbcl or ksads ~ stress prs + sex + age + ancestry PCs, r}
...
lm_eur_stressprs_total$fixef
lm_eur_stressprs_ext$fixef
lm_eur_stressprs_int$fixef
lm_eur_stressprs_agg$fixef
lm_eur_stressprs_attn$fixef
lm_eur_stressprs_anxdep$fixef
lm_eur_stressprs_rule$fixef
lm_eur_stressprs_social$fixef
lm_eur_stressprs_somatic$fixef
lm_eur_stressprs_thought$fixef
lm_eur_stressprs_withdep$fixef
lm_eur_stressprs_adhd$fixef
lm_eur_stressprs_anxiety$fixef
lm_eur_stressprs_mdd$fixef
lm_eur_stressprs_ptsd$fixef
