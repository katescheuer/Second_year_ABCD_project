...
p.adjust(c(lm_eur_stressprs_total$fixef$pval[2], #not sig
...
p.adjust(c(lm_eur_stressprs_total$fixef$pval[3], #not sig
...
### adjusted p-values for sex only
p.adjust(c(lm_afr_stressprs_total$fixef$pval[3], #not sig
...
### adjusted p-values for prs only
p.adjust(c(lm_amadmix_stressprs_total$fixef$pval[2], #not sig
           ...
           lm_amadmix_stressprs_anxiety$fixef$pval[2], #***sig
           lm_amadmix_stressprs_mdd$fixef$pval[2], #***sig
           lm_amadmix_stressprs_ptsd$fixef$pval[2]), #not sig
           method="fdr")

### adjusted p-values for sex only
p.adjust(c(lm_amadmix_stressprs_total$fixef$pval[3], #not sig
...
p.adjust(c(lm_amadmix_stressprs_total$fixef$pval[4], #not sig
