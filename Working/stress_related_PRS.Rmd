...
yr4_reg_data <- yr4_data %>%
                ...
                mutate(gender = case_when(gender == 1 ~ "cism",
                                          gender == 2 ~ "cisf",
                                          ### see what happens when remove gnc subjects
                                          gender == 3 ~ NA, #trans m
                                          gender == 4 ~ NA, #trans f
                                          gender == 5 ~ NA, #genderqueer
                                          gender == 6 ~ NA, #other
...
## dummy without gnc
# gender - cismale: gen_dum_cism = 0, gen_dum_cism = 1
## dummy
...
## effect without gnc
# gender - cismale: gen_eff_cism = -1, gen_eff_cisf = 1
## effect
...
cbcl_total_M2a <- lmer(res_c_total ~ zcmc_prs + zcmc_age + zcmc_income +
                      ...
                      (0+gen_cmc_cisf|site), #don't have enough to add more variables to random slope
...
# eur, afr: failed to converge with either optimizer
...
# all, eur, afr, amadmix, all w/o gnc: best fitting model is fixed slope without interactions
# all, eur, afr, amadmix, all w/o gnc: if want to include interactions, use fixed slope
...
##      M1b: income, cisf, gnc
## All without gnc: 
##      M1a: income (cisf p=0.387)
##      M1b: income (cisf p=0.412)
## Eur: 
##      M1a: income, cisf, gnc
##      M1b: income, cisf, gnc
## Afr: 
...
##      M1b: income, cisf, gnc
## All without gnc: 
##      M1a: income, cisf (p=0.011)
##      M1b: income, cisf (p=0.010)
## Eur: 
##      M1a: income, cisf, gnc
##      M1b: income, cisf, gnc
## Afr: 
...
### Random Intercept, random slopes, random effects free to correlate with interactions ----
# all, amadmix: failed to converge with either optimizer
...
## All without gnc: 
##      M1a: income, cisf (p=0.002)
##      M1b: income, cisf (p=0.002)
## Eur: 
##      M1a: income, cisf, gnc
##      M1b: income, cisf, gnc
## Afr: 
...
anova(cbcl_attn_M1a,cbcl_attn_M2c,test="Chisq") #1a is better
anova(cbcl_attn_M1a,cbcl_attn_M2d,test="Chisq") #1a is better
anova(cbcl_attn_M1b,cbcl_attn_M2b,test="Chisq") #1b is better
anova(cbcl_attn_M1b,cbcl_attn_M2d,test="Chisq") #1b is better
# all, eur, afr, amadmix, all w/o gnc: best fitting model is fixed slope without interactions
# all, eur, afr, amadmix, all w/o gnc: if want to include interactions, use fixed slope
...
##      M1b: income, cisf, gnc
## All without gnc: 
##      M1a: income (cisf p=0.705)
##      M1b: income (cisf p=0.732)
## Eur: 
##      M1a: income, cisf, gnc
##      M1b: income, cisf, gnc
## Afr: 
...
## All without gnc: 
##      M1a: cisf (p=0.003) (income p = 0.079)
##      M1b: cisf (p=0.003) (income p = 0.082)
## Eur: 
...
## All without gnc: 
##      M1a: income (cisf p = 0.482)
##      M1b: income (cisf p = 0.496)
## Eur: 
##      M1a: income, cisf, gnc
...
anova(cbcl_rule_M1a,cbcl_rule_M2d,test="Chisq") #1a is better
anova(cbcl_rule_M1b,cbcl_rule_M2b,test="Chisq") #1b is better
anova(cbcl_rule_M1b,cbcl_rule_M2d,test="Chisq") #1b is better
# all, eur, afr, amadmix, all w/o gnc: best fitting model is fixed slope without interactions
# all, eur, afr, amadmix, all w/o gnc: if want to include interactions, use fixed slope
...
##      M1b: income, cisf, gnc
## All without gnc: 
##      M1a: income (cisf p = 0.398)
##      M1b: income (cisf p = 0.388)
## Eur: 
##      M1a: income, cisf, gnc
##      M1b: income, cisf, gnc
## Afr: 
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
# all, eur, all w/o gnc: failed to converge with either optimizer
...
##      M1b: income, cisf, gnc
## All without gnc: 
##      M1a: income (cisf p = 0.544)
##      M1b: income (cisf p = 0.542)
## Eur: 
##      M1a: income, cisf, gnc
##      M1b: income, cisf, gnc
## Afr: 
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
# all, eur, afr, amadmix, all w/o gnc: failed to converge with either optimizer
...
## All without gnc: 
##      M1a: income (cisf p = 0.072)
##      M1b: income (cisf p = 0.076)
## Eur: 
...
### Model Comparisons of AIC/BIC fit indices and Likelihood Ratio Test (LRT) ----
anova(cbcl_thought_M1a,cbcl_thought_M1b,test="Chisq")  #all, eur, amadmix, all w/o gnc: 1b is better; afr: 1a is better
anova(cbcl_thought_M1b,cbcl_thought_M2a,test="Chisq") #all, eur, amadmix, all w/o gnc: 1b is better
anova(cbcl_thought_M1b,cbcl_thought_M2b,test="Chisq") #all, eur, amadmix, all w/o gnc: 1b is better
...
# all, eur, amadmix, all w/o gnc: best fitting model is fixed slope with interactions
...
## All without gnc: 
##      M1b: income, prs (p=0.013), prs*income (p=0.009) (cisf p = 0.465)
## Eur: 
...
# all, eur, all w/o gnc: best fitting model is fixed slope without interactions
# all, eur, all w/o gnc: if want to include interactions, use fixed slope
...
##      M1b: no sig
## All without gnc: 
##      M1a: no sig (cisf p=0.074)
##      M1b: no sig (cisf p=0.074)
## Eur: 
##      M1a: no sig
##      M1b: no sig
...
### Random Intercept, random slopes, random effects free to correlate without interactions ----
# all, eur, afr, all w/o gnc: failed to converge with either optimizer
...
# all, afr, all w/o gnc: best fitting model is fixed slope without interactions
# all, afr, all w/o gnc: if want to include interactions, use fixed slope
...
### Model Comparisons of AIC/BIC fit indices and Likelihood Ratio Test (LRT) ----
anova(ksads_ptsd_M1a,ksads_ptsd_M1b,test="Chisq")  #all, eur, all w/o gnc: 1a is better; afr: 1b is better
anova(ksads_ptsd_M1a,ksads_ptsd_M2a,test="Chisq") #all, eur, all w/o gnc: 1a is better
anova(ksads_ptsd_M1a,ksads_ptsd_M2b,test="Chisq") #all, eur, all w/o gnc: 1a is better
...
anova(ksads_ptsd_M1b,ksads_ptsd_M2b,test="Chisq") #all, eur, all w/o gnc: 1b is better
# all, eur, all w/o gnc: best fitting model is fixed slope without interactions
# all, eur, all w/o gnc: if want to include interactions, use fixed slope
...
## All without gnc: 
##      M1a: income (p=0.021), cisf (p=0.003)
##      M1b: income (p=0.020), cisf (p=0.003)
## Eur: 
...
cbcl_total_M1b <- lmer(res_c_total ~  + zcmc_age + zcmc_income +
                        ...
                        zcmc_income*gen_cmc_cisf + zcmc_income*gen_cmc_gnc +
                      (1|site),
                    data=yr4_reg_data, REML=FALSE)
summary(cbcl_total_M1b)
